...
$("extension-version").textContent = `v${installedVersion}`;
$("extension-version").title = `Installed extension: v${installedVersion}. After updating, reload the extension and refresh the EA Web App.`;
